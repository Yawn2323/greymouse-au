...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_country-details_country-details_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./country-details/country-details.module */ 4266)).then(m => m.CountryDetailsPageModule)
    },
    {
        path: '',
        redirectTo: 'home',
